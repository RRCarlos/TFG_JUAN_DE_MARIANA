...
> **Nota de estado:** el proyecto se encuentra en fase de **verificación manual** de las citas, entrada por entrada (la revisión de entradas actualmente va por la 45). Las cifras de este documento son provisionales y pueden variar hasta completar la revisión.
